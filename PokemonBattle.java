...
public class PokemonBattle {
    ...
    public static final String charizardString = String.join("\n", new String[]{
"                 " + Color.ANSI_RED + ".\"-,.__" + Color.ANSI_RESET,
"                 " + Color.ANSI_RED + "`.     `.  ," + Color.ANSI_RESET,
"              " + Color.ANSI_RED + ".--'  .._,'\"-' `." + Color.ANSI_RESET,
"             " + Color.ANSI_RED + ".    .'         `'" + Color.ANSI_RESET,
"             " + Color.ANSI_RED + "`.   /          ,'" + Color.ANSI_RESET,
"               " + Color.ANSI_RED + "`  '--.   ,-\"'" + Color.ANSI_RESET,
"                " + Color.ANSI_RED + "`\"`   |  \\" + Color.ANSI_RESET,
"                   " + Color.ANSI_RED + "-. \\, |" + Color.ANSI_RESET,
"                    " + Color.ANSI_RED + "`--Y.'" + Color.ANSI_RESET + "      ___.",
"                         " + Color.ANSI_RED + "\\" + Color.ANSI_RESET + "     L._, \\",
"               _.,        `.   <  <\\                _",
"             ,' '           `, `.   | \\            ( `",
"          ../, `.            `  |    .\\`.           \\ \\_",
"         ,' ,..  .           _.,'    ||\\l            )  '\".",
